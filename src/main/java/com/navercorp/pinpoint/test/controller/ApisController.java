...
public class ApisController {
    ...
    private void initApiMappings() {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> requestMappedHandlerEntry : requestMappedHandlers.entrySet()) {
            ...
            Package handlerMethodBeanPackage = handlerMethodBeanClazz.getPackage();
            // only include controllers within this package
            if (!handlerMethodBeanPackage.getName().equals(this.getClass().getPackage().getName())) {
                continue;
            }
